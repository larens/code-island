...
struct IDEExtensionInstaller {
    nonisolated private static let extensionPublisher = "code-island"
    ...
    nonisolated private static let projectHomepage = "https://github.com/erha19/code-island"
    nonisolated private static let projectRepository = "https://github.com/erha19/code-island.git"
    nonisolated private static let projectIssues = "https://github.com/erha19/code-island/issues"
    ...
    private static func extensionJS(for profile: ManagedIDEExtensionProfile) -> String {
        ...
        async function handleSetupURI(uri) {
            ...
            await vscode.window.showInformationMessage('Code Island is ready in \(profile.title).');
        }
