...
enum ClientProfileRegistry {
    nonisolated static let managedHookProfiles: [ManagedHookClientProfile] = [
        ManagedHookClientProfile(
            id: "claude-hooks",
            title: "Claude Code",
            subtitle: "管理 ~/.claude/settings.json，使用统一 CodeIslandBridge hooks 入口",
        ...
        ManagedHookClientProfile(
            id: "hermes-hooks",
            title: "Hermes",
            subtitle: "管理 ~/.hermes/plugins/code_island，按 Hermes 官方 plugin hooks 协议接入 Island",
            installationKind: .pluginDirectory,
            alwaysVisibleInSettings: true,
            logoAssetName: "HermesLogo",
            prefersBundledLogoOverAppIcon: true,
            iconSymbolName: "paperplane.circle.fill",
            configurationRelativePath: ".hermes/plugins/code_island",
            bridgeSource: "claude",
            bridgeExtraArguments: [
                "--client-kind", "hermes",
                "--client-name", "Hermes",
        ...
        ManagedHookClientProfile(
            id: "openclaw-hooks",
            title: "OpenClaw",
            subtitle: "管理 ~/.openclaw/hooks/code-island-openclaw，并自动启用内部 hook",
            installationKind: .hookDirectory,
            alwaysVisibleInSettings: true,
            logoAssetName: "OpenClawLogo",
            prefersBundledLogoOverAppIcon: true,
            iconSymbolName: "bird.fill",
            configurationRelativePath: ".openclaw/hooks/code-island-openclaw",
            activationConfigurationRelativePath: ".openclaw/openclaw.json",
            activationEntryName: "code-island-openclaw",
            bridgeSource: "claude",
            bridgeExtraArguments: [
        ...
        ManagedHookClientProfile(
            id: "opencode-hooks",
            title: "OpenCode",
            subtitle: "管理 ~/.config/opencode/plugins/code-island.js，按 OpenCode 官方插件 hooks 接入 Island",
            ...
            configurationRelativePath: ".config/opencode/plugins/code-island.js",
    ...
    nonisolated static let ideExtensionProfiles: [ManagedIDEExtensionProfile] = [
        ...
        ManagedIDEExtensionProfile(
            id: "qoder-extension",
            title: "Qoder",
            subtitle: "安装 Code Island，支持会话跳转与终端精准聚焦",
            logoAssetName: "QoderLogo",
            prefersBundledLogoOverAppIcon: true,
