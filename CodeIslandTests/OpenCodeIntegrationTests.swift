...
final class OpenCodeIntegrationTests: XCTestCase {
    func testOpenClawManagedProfileUsesHookDirectoryInstallation() {
        ...
        XCTAssertEqual(profile?.primaryConfigurationURL.path, NSHomeDirectory() + "/.openclaw/hooks/code-island-openclaw")
        XCTAssertEqual(profile?.activationConfigurationURL?.path, NSHomeDirectory() + "/.openclaw/openclaw.json")
        XCTAssertEqual(profile?.activationEntryName, "code-island-openclaw")
    ...
    func testOpenClawConversationParserReadsMultiTurnSessionFile() async throws {
        ...
        let content = """
        {"type":"session","version":3,"id":"openclaw-session","timestamp":"2026-04-11T15:43:20.000Z","cwd":"/Users/code-island/.openclaw/workspace"}
    ...
    func testOpenCodeManagedProfileUsesPluginFileInstallation() {
        ...
        XCTAssertEqual(profile?.primaryConfigurationURL.path, NSHomeDirectory() + "/.config/opencode/plugins/code-island.js")
    ...
    func testOpenCodeActivationConfigInstallsPluginEntryWithoutRemovingOthers() throws {
        let existingJSON = """
        {
          ...
          "plugin": [
            "file:///Users/code-island/.config/opencode/plugins/open-island.js"
          ]
        }
        """.data(using: .utf8)
        ...
        XCTAssertTrue(plugins.contains("file:///Users/code-island/.config/opencode/plugins/open-island.js"))
    ...
    func testOpenCodeActivationConfigRemovesOnlyCodeIslandPluginEntry() throws {
        let existingJSON = """
        {
          "$schema": "https://opencode.ai/config.json",
          "plugin": [
            "file:///Users/code-island/.config/opencode/plugins/open-island.js",
            "file:///Users/code-island/.config/opencode/plugins/code-island.js"
          ]
        }
        """.data(using: .utf8)
