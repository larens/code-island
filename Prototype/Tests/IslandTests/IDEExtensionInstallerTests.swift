...
private let repositoryURL = "https://github.com/erha19/code-island"
...
func installerWritesVSCodeCompatibleExtensionPayload() throws {
    ...
    let vscodeExtensionURL = root
        ...
        .appending(path: "code-island.session-focus-\(version)", directoryHint: .isDirectory)
    ...
    #expect(packageJSON.contains("\"publisher\": \"code-island\""))
    #expect(packageJSON.contains("\"displayName\": \"Code Island\""))
    ...
    #expect((qoderRegistryEntry["relativeLocation"] as? String) == "code-island.session-focus-\(version)")
...
private func projectMarketingVersion() -> String {
    let projectURL = URL(fileURLWithPath: #filePath)
        ...
        .deletingLastPathComponent()
        .deletingLastPathComponent()
        .appending(path: "CodeIsland.xcodeproj/project.pbxproj")
