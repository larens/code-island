...
func drawBackground(configuration: Configuration) throws {
    ...
    guard
        ...
        throw NSError(domain: "CodeIslandDMG", code: 65, userInfo: [NSLocalizedDescriptionKey: "Failed to allocate bitmap"])
    }
    ...
    guard let context = NSGraphicsContext(bitmapImageRep: bitmap) else {
        throw NSError(domain: "CodeIslandDMG", code: 66, userInfo: [NSLocalizedDescriptionKey: "Failed to create graphics context"])
    }
    ...
    guard let data = bitmap.representation(using: .png, properties: [:]) else {
        throw NSError(domain: "CodeIslandDMG", code: 67, userInfo: [NSLocalizedDescriptionKey: "Failed to encode PNG"])
    }
