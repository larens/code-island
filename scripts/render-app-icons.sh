...
SOURCE_SVG="${ROOT_DIR}/docs/images/code-island-icon.svg"
OUTPUT_DIR="${ROOT_DIR}/CodeIsland/Assets.xcassets/AppIcon.appiconset"

usage() {
  cat <<'EOF'
Usage: render-app-icons.sh [--source <svg-path>] [--output-dir <path>]

Regenerates the macOS AppIcon asset set from the Code Island SVG source.
