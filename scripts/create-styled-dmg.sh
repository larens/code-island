...
BRAND_LOGO_SOURCE="${CODE_ISLAND_DMG_LOGO_SOURCE:-$PROJECT_DIR/docs/images/code-island-icon-transparent.svg}"
DMG_BACKGROUND_SOURCE="${CODE_ISLAND_DMG_BACKGROUND_SOURCE:-$PROJECT_DIR/docs/images/code-island-dmg-installer-background.png}"
DMG_ICON_SOURCE="${CODE_ISLAND_DMG_ICON_SOURCE:-}"
FALLBACK_ICON_PNG="$PROJECT_DIR/CodeIsland/Assets.xcassets/AppIcon.appiconset/icon_1024x1024.png"

VOLNAME=""
SOURCE_DIR=""
OUTPUT_DMG=""
APP_NAME="Code Island.app"
WINDOW_WIDTH="${CODE_ISLAND_DMG_WINDOW_WIDTH:-768}"
WINDOW_HEIGHT="${CODE_ISLAND_DMG_WINDOW_HEIGHT:-512}"
ICON_SIZE="${CODE_ISLAND_DMG_ICON_SIZE:-108}"
APP_X="${CODE_ISLAND_DMG_APP_X:-212}"
APP_Y="${CODE_ISLAND_DMG_APP_Y:-246}"
APPLICATIONS_X="${CODE_ISLAND_DMG_APPLICATIONS_X:-602}"
APPLICATIONS_Y="${CODE_ISLAND_DMG_APPLICATIONS_Y:-248}"
FAIL_ON_PLAIN="${CODE_ISLAND_DMG_FAIL_ON_PLAIN:-0}"
FINDER_VOLUME_NAME=""
...
Environment:
  CODE_ISLAND_DMG_BACKGROUND_SOURCE  Optional background image override
EOF
}
...
TMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/code-island-dmg.XXXXXX")"
