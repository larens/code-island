...
private struct PosterOptions {
    ...
    init(arguments: [String]) throws {
        ...
        var outputName = "code-island-ssh-claude-poster.png"
        var width = 2800
        var height = 1800
    ...
    var errorDescription: String? {
        ...
        case .helpText:
            ...
            Usage: render-ssh-claude-poster.sh [options]
              ...
              --output-name <name>  Output filename (default: code-island-ssh-claude-poster.png)
        ...
        HStack(spacing: 62) {
            ...
            VStack(alignment: .leading, spacing: 18) {
                HStack(spacing: 14) {
                    ...
                    Badge(text: "Code Island", tint: Color(red: 0.95, green: 0.73, blue: 0.33))
                }
    ...
    private var narrativeCard: some View {
        VStack(alignment: .leading, spacing: 28) {
            ...
            VStack(alignment: .leading, spacing: 16) {
                Text("把远程 Claude Code 会话带回 Code Island")
                    .font(.system(size: 56, weight: .bold, design: .rounded))
                    .foregroundStyle(Color(red: 0.18, green: 0.13, blue: 0.10))

                Text("添加 SSH 主机后，Code Island 会在远程机器上部署 bridge，接住 hooks，再把远程事件稳定转发回本机。")
